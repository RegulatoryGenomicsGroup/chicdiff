...
```{r, warning=FALSE}
mini_output <- readRDS(file.path(resultsPath, "Weighted.Rds"))
...
outpeak <- getCandidateInteractions(defchic.settings = defchic.settings, output = output, peakFiles = peakFiles, pvcut = 0.05, deltaAsinhScore =1)
