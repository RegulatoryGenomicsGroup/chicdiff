...
The plots produced by Chicdiff for the chr19 datasets are provided in the *ChicdiffData* package and can be vizualized in the following way: 
...
1. *IHW decision boundary plot*: This plot shows whether the covariate (distance) in the control dataset is informative of the power under the alternative, and thus the IHW can be used.
