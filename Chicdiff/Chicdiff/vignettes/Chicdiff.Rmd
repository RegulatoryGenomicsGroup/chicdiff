...
Chicdiff produces a plot, showing four random baits, from the top 100 baits, containing interactions with the lowest weighted pvalue.

```{r}
IHWweightPlot <- readPNG(file.path(resultsPath,"diffbaitPlot.png"))
grid::grid.raster(IHWweightPlot)
```
