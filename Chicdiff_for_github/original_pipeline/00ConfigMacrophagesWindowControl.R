...
resourceDir <- "macrophageWindow/control"
...
targetRDAs <- list(
  MacFold1 = c("/bi/group/fraser/GWAS_Processing/Samples/Samples/Mac0/CHiCAGO/res_Mac0_13_Step2_chicago2_reweight/data/Mac0_13_Step2.RDa",
  ...
  MacFold2 = c("/bi/group/fraser/GWAS_Processing/Samples/Samples/Batch4/Mac1/CHiCAGO/res_Mac1_63_Step2_chicago2_reweight/data/Mac1_63_Step2.RDa",
...
targetChs <- list(
  MacFold1 = c("Data/Mac0_13_Step1_bait_otherEnd_N_len_distSign.txt",
  ...
  MacFold2 = c("Data/Mac1_63_Step1_bait_otherEnd_N_len_distSign.txt",
...
#manner to expand in ("window" or "union")
RUmergeMode <- "window"
